(function(g){var window=this;var Bta=function(a,b){var c=[];g.Jf(b,function(a){var b;try{b=g.aj.prototype.o.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}g.p(b)?g.$i(b)&&c.push(a):c.push(a)},a);
return c},Cta=function(a,b){var c=Bta(a,b);
(0,g.F)(c,function(a){g.aj.prototype.remove.call(this,a)},a)},Dta=function(a){return a.H?a.F+((0,g.E)()-a.A)/1E3:a.F},Eta=function(){var a=g.bj;
Cta(a,a.g.Ad(!0))},v9=function(a){g.Iw.call(this,"ScreenServiceProxy");
this.Nc=a;this.o=[];this.o.push(this.Nc.$_s("screenChange",(0,g.z)(this.kL,this)));this.o.push(this.Nc.$_s("onlineScreenChange",(0,g.z)(this.RH,this)))},w9=function(a){g.Ew("cloudview",a)},Fta=function(a){w9("setApiReady_ "+a);
g.ka("yt.mdx.remote.cloudview.apiReady_",a,void 0)},x9=function(){return g.u("yt.mdx.remote.cloudview.instance_")},Gta=function(a){g.Fi[a]&&(a=g.Fi[a],(0,g.F)(a,function(a){g.Di[a]&&delete g.Di[a]}),a.length=0)},y9=function(){return g.u("yt.mdx.remote.connection_")},z9=function(a){g.ka("yt.mdx.remote.connectData_",a,void 0)},Hta=function(a){g.ka("yt.mdx.remote.currentScreenId_",a,void 0)},A9=function(){return g.u("yt.mdx.remote.currentScreenId_")},C9=function(){if(!B9){var a=g.u("yt.mdx.remote.screenService_");
...
g.dj("yt-remote-cast-installed",a)},G9=function(a){g.Ew("cloudview",a)},Ita=function(a,b){x9().init(a,b)},H9=function(){return!!g.ej("yt-remote-cast-installed")},Jta=function(){w9("dispose");
var a=x9();a&&a.dispose();g.ka("yt.mdx.remote.cloudview.instance_",null,void 0);Fta(!1);g.Hi(I9);I9.length=0},Kta=function(){var a=window.document.createElement("a");
g.we(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Oa(a)},Lta=function(a,b){var c=window.document.createElement("script");
...
c.src="https://www.gstatic.com/cv/js/sender/v1/cast_sender.js";var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},Mta=function(a){var b=g.Bi();
if(b)if(b.clear(a),a)Gta(a);else for(var c in g.Fi)Gta(c)},J9=function(){return g.u("yt.mdx.remote.channelParams_")||{}},L9=function(a){var b=y9();
z9(null);a||Hta("");g.ka("yt.mdx.remote.connection_",a,void 0);K9&&((0,g.F)(K9,function(b){b(a)}),K9.length=0);
b&&!a?g.Ki("yt-remote-connection-change",!1):!b&&a&&g.Ki("yt-remote-connection-change",!0)},Nta=function(){return g.u("yt.mdx.remote.connectData_")},M9=function(){var a=A9();
if(!a)return null;var b=C9().Ed();return g.ii(b,a)},Ota=function(a,b){F9(!0);
D9(!1);Ita(a,function(a){a?(Fta(!0),g.Ji("yt-remote-cast2-api-ready")):(G9("Failed to initialize cast API."),F9(!1),g.fj("yt-remote-cast-available"),g.fj("yt-remote-cast-receiver"),Jta());b(a)})},Pta=function(){return H9()?x9()?x9().getCastSession():(G9("getCastSelector: Cast is not initialized."),null):(G9("getCastSelector: Cast API is not installed!"),null)},Qta=function(){if(g.ooa){var a=2,b=g.tw(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;g.yw("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",g.vw,c)}},Rta=function(){var a=Kta(),b=window.document.getElementById(a),c=b&&g.ch(b,"loaded");
c||b&&!c||(b=Lta(a,function(){g.ch(b,"loaded")||(g.bh(b,"loaded","true"),g.Ji(a),g.ni(g.va(Mta,a),0))}))},Sta=function(a){return(0,g.Q)(a,function(a){return{key:a.id,
name:a.name}})},O9=function(a,b){A9();
M9()&&M9();Hta(a.id);var c=new g.Uy(N9,a,J9());c.connect(b,Nta());c.subscribe("beforeDisconnect",function(a){g.Ki("yt-remote-before-disconnect",a)});
...
var a=y9();a&&(a.disconnect(1),L9(null))},Tta=function(){var a;
a=C9().Nc.$_gos();var b=M9();b&&y9()&&(g.hi(a,b)||a.push(b));return Sta(a)},U9=function(a,b){g.$m.call(this);
this.g=0;this.B=a;this.D=[];this.C=new g.Jy;this.A=this.o=null;this.H=(0,g.z)(this.hG,this);this.F=(0,g.z)(this.Qi,this);this.G=(0,g.z)(this.gG,this);this.J=(0,g.z)(this.rG,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Rp,this),Uta(this))):c=3;0!=c&&(b?this.Rp(c):g.ni((0,g.z)(function(){this.Rp(c)},this),0));
var d=Pta();d&&T9(this,d);this.subscribe("yt-remote-cast2-session-change",this.J)},V9=function(a){return new g.Oy(a.B.getPlayerContextData())},Vta=function(a,b,c,d,e){var f=V9(a),k=e||f.listId;
d=d||0;var l={videoId:b,currentIndex:d};g.Sy(f,b,d);g.p(c)&&(g.Qy(f,c),l.currentTime=c);g.p(k)&&(l.listId=k);W9(a,"setPlaylist",l);e||X9(a,f)},Uta=function(a){(0,g.F)("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(a){this.D.push(this.B.subscribe(a,g.va(this.kI,a),this))},a)},Wta=function(a){(0,g.F)(a.D,function(a){this.B.unsubscribeByKey(a)},a);
a.D.length=0},Y9=function(a,b){50>a.C.sc()&&g.Ly(a.C,b)},Z9=function(a,b,c){var d=V9(a);
g.Qy(d,c);-1E3!=d.g&&(d.g=b);X9(a,d)},W9=function(a,b,c){a.B.sendMessage(b,c)},X9=function(a,b){Wta(a);
a.B.setPlayerContextData(g.Ty(b));Uta(a)},T9=function(a,b){a.A&&(a.A.removeUpdateListener(a.H),a.A.removeMediaListener(a.F),a.Qi(null));
a.A=b;a.A&&($9("Setting cast session: "+a.A.sessionId),a.A.addUpdateListener(a.H),a.A.addMediaListener(a.F),a.A.media.length&&a.Qi(a.A.media[0]))},Xta=function(a){var b=a.o.media,c=a.o.customData;
...
a.code!=window.chrome.cast.ErrorCode.TIMEOUT&&(this.Tb("Retrying "+b+" using MDx browser channel."),W9(this,b,c))},a)},Yta=function(a){var b=!1;
...
w9("cloudview.createSingleton_: "+b);return b},Zta=function(){var a=0<=g.fc.search(/\ (CrMo|Chrome|CriOS)\//);
return g.xi||a},b$=function(a,b){E9()?x9().setConnectedScreenStatus(a,b):G9("setConnectedScreenStatus called before ready.")},$ta=function(){w9("clearCurrentReceiver");
g.fj("yt-remote-cast-receiver")},aua=function(){if(0<=window.navigator.userAgent.indexOf("CriOS")){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
if(a){Qta();a({command:"cast.sender.init"});return}}if(window.chrome)if(Qta(),a=window.navigator.userAgent,0<=a.indexOf("Android")&&0<=a.indexOf("Chrome/")&&window.navigator.presentation){var a="",b=g.qw();55<=b?a="55":50<=b&&(a="50");g.yw("//www.gstatic.com/eureka/clank"+a+g.ww,g.vw)}else g.zw(0);else g.vw()},bua=function(a){a?(g.dj("yt-remote-session-app",a.app),g.dj("yt-remote-session-name",a.name)):(g.fj("yt-remote-session-app"),g.fj("yt-remote-session-name"));
g.ka("yt.mdx.remote.channelParams_",a,void 0)},cua=function(){var a=J9();
if(g.Sb(a)){var a=g.hj(),b=g.ej("yt-remote-session-name")||"",c=g.ej("yt-remote-session-app")||"",a={device:"REMOTE_CONTROL",id:a,name:b,app:c,"mdx-version":3};g.ka("yt.mdx.remote.channelParams_",a,void 0)}},dua=function(){var a=P9();
a?(Q9("Resume connection to: "+g.ei(a)),O9(a,0)):(g.rj(),$ta(),Q9("Skipping connecting because no session screen found."))},eua=function(a){Q9("remote.onCastSessionChange_: "+g.ei(a));
if(a){var b=M9();b&&b.id==a.id?b$(b.id,"YouTube TV"):(b&&S9(),O9(a,1))}else y9()&&S9()},fua=function(){var a=Tta(),b=M9();
b||(b=P9());return g.Wa(a,function(a){return b&&g.bi(b,a.key)?!0:!1})},gua=function(){var a=g.ej("yt-remote-cast-receiver");
return a?a.friendlyName:null},hua=function(a,b,c,d){Zta()?Yta(b)&&(D9(!0),window.chrome&&window.chrome.cast&&window.chrome.cast.isAvailable?Ota(a,c):(window.__onGCastApiAvailable=function(b,d){b?Ota(a,c):(G9("Failed to load cast API: "+d),F9(!1),D9(!1),g.fj("yt-remote-cast-available"),g.fj("yt-remote-cast-receiver"),Jta(),c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):Rta():aua())):w9("Cannot initialize because not running Chrome")},
iua=function(a){this.B=this.A="";
...
c.H=b||0;c.g.Ra("progresssync",b,d)},jua=function(a){d$(a,0);
a.o.stop();e$(a,new g.sl(64))},h$=function(a,b){if(f$(a)&&!a.C){var c=null;
b&&(c={style:a.X.rj()},g.$b(c,b));a.g.Nw(g$(a),c);a.B=V9(a.g).o}},i$=function(a,b){var c=a.X.ve();
c?Vta(a.g,g$(a),b,c.g,c.listId.toString()):Vta(a.g,g$(a),b);e$(a,new g.sl(1))},kua=function(a,b){if(b){var c=a.X.Hc("captions","tracklist",{xu:1});
...
var c=a.D;if(b.o!=c.o||b.g!=c.g){var d=g.S(b,2);if(d!=g.S(a.D,2)){var e=a.X;(e=g.Vl(e.app,e.playerType||1))&&g.OU(e,d)}a.D=b;lua(a.H,c,b)}},j$=function(){var a=fua();
!a&&H9()&&gua()&&(a={key:"cast-selector-receiver",name:gua()});return a},mua=function(){var a=Tta();
H9()&&g.ej("yt-remote-cast-available")&&a.push({key:"cast-selector-receiver",name:"Cast..."});return a},nua=function(a){var b={device:"Desktop",
app:"youtube-desktop"};g.bj&&Eta();g.kj();N9||(N9=new iua,g.tj()&&(N9.g="/api/loungedev"));K9||(K9=g.u("yt.mdx.remote.deferredProxies_")||[],g.ka("yt.mdx.remote.deferredProxies_",K9,void 0));cua();var c=C9();if(!c){var d=new g.Vw(N9);g.ka("yt.mdx.remote.screenService_",d,void 0);c=C9();hua(a,d,function(a){a?A9()&&b$(A9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){g.Ki("yt-remote-receiver-availability-change")})},!(!b||!b.loadCastApiSetupScript))}b&&!g.u("yt.mdx.remote.initialized_")&&
...
g.Ki("yt-remote-auto-connect","cast-selector-receiver")})),k$.push(g.Gi("yt-remote-cast2-receiver-resumed",function(){g.Ki("yt-remote-receiver-resumed","cast-selector-receiver")})),k$.push(g.Gi("yt-remote-cast2-session-change",eua)),k$.push(g.Gi("yt-remote-connection-change",function(a){a?b$(A9(),"YouTube TV"):P9()||(b$(null,null),$ta())})),a=J9(),b.isAuto&&(a.id+="#dial"),g.ym("desktop_enable_autoplay")&&(a.capabilities=["atp"]),a.name=b.device,a.app=b.app,Q9(" -- with channel params: "+g.tf(a)),
bua(a),c.start(),A9()||dua())},l$=function(){H9()?x9()?E9()?(w9("Requesting cast selector."),x9().requestSession()):(w9("Wait for cast API to be ready to request the session."),I9.push(g.Gi("yt-remote-cast2-api-ready",l$))):G9("requestCastSelector: Cast is not initialized."):G9("requestCastSelector: Cast API is not installed!")},m$=function(a){g.iu.call(this,a);
this.A={key:g.gi(),name:g.P("YTP_MDX_MY_COMPUTER")};this.C=null;this.D=[];this.J=this.o=null;this.G=[this.A];this.B=this.A;this.F=new g.sl(64);this.H=0},lua=function(a,b,c){a.F=c;
...
g.h.R=function(){Wta(this);this.B=null;this.C.clear();T9(this,null);U9.M.R.call(this)};
...
g.h.Qi=function(a){$9("Cast media: "+!!a);this.o&&this.o.removeUpdateListener(this.G);if(this.o=a)this.o.addUpdateListener(this.G),Xta(this),this.aa("remotePlayerChange")};
g.h.gG=function(a){a?(Xta(this),this.aa("remotePlayerChange")):this.Qi(null)};
g.h.rG=function(){var a=Pta();a&&T9(this,a)};
g.h.Tb=function(a){g.Ew("CP",a)};
var k$=[];g.h=iua.prototype;g.h.ng=function(a,b,c){var d=this.g;if(g.p(c)?c:this.o)d="https://"+this.A+this.B+this.g;return g.cg(d+a,b||{})};
...
g.h.Av=function(){g.Sb(this.B)||kua(this,this.B);this.C=!1};
...
new g.sl(128,a))}var a=V9(this.g).o,b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.format==b.format&&a.kind==b.kind:1)||(this.B=a,kua(this,a));a=V9(this.g);-1==a.volume||Math.round(this.X.getVolume())==a.volume&&this.X.Id()==a.muted||this.G.isActive()||this.gx()}else jua(this)};
g.h.Kv=function(){this.X.Ra("mdxpreviousnextchange")};
g.h.Ti=function(){f$(this)||jua(this)};
...
g.B(m$,g.iu);g.h=m$.prototype;g.h.create=function(){nua("embedded"==g.U(this.g).g);this.D.push(g.Gi("yt-remote-before-disconnect",this.dG,this));this.D.push(g.Gi("yt-remote-connection-change",this.sI,this));this.D.push(g.Gi("yt-remote-receiver-availability-change",this.Lv,this));this.D.push(g.Gi("yt-remote-auto-connect",this.qI,this));this.D.push(g.Gi("yt-remote-receiver-resumed",this.pI,this));this.Lv()};
g.h.load=function(){this.g.gn();m$.M.load.call(this);this.C=new c$(this,this.g,this.o);var a;a=(a=Nta())?a.currentTime:0;var b=R9()?new U9(y9(),void 0):null;0==a&&b&&(a=g.Ry(V9(b)));0!=a&&(this.H=a||0,this.g.Ra("progresssync",a,void 0));lua(this,this.F,this.F);g.k2(this.g.app,6)};
g.h.unload=function(){this.g.Ra("mdxautoplaycanceled");this.B=this.A;g.Eb(this.C,this.o);this.o=this.C=null;m$.M.unload.call(this);g.k2(this.g.app,5)};
...
g.h.SM=function(){var a=V9(this.o),b=this.g.getVideoData(),c=g.km(this.g),d=b.clipEnd,b=b.clipStart,e=this.getCurrentTime(),f=a.getDuration(),k;k=a.H?a.B+((0,g.E)()-a.A)/1E3:a.B;var l=1>=Dta(a)-this.getCurrentTime(),m=a.J,n=Dta(a),a=0<a.C?a.C+((0,g.E)()-a.A)/1E3:a.C;return{allowSeeking:c,clipEnd:d,clipStart:b,current:e,displayedStart:-1,duration:f,ingestionTime:k,isPeggedToLive:l,loaded:m,seekableEnd:n,seekableStart:a}};
...
g.h.Lv=function(){this.G=[this.A].concat(mua());var a=j$()||this.A;n$(this,a,!this.loaded);this.g.ya("onMdxReceiversChange")};
